...
global path
path = '/Users/bishalthapa/Desktop/2024/Cyber Physical System/Final Project/BC/Gossip Socket/2024Crypt/B/1.txt'
    ...
    def __init__(self):
        ...
        def exists(filename):
            ...
            if os.path.exists(path1):
                ...
                pass
                print(f'Index {new_index} doesnot exists') 
...
########################################################
    ...
    def add_block(self, file_name):
        ...
        # with open("blocks.txt", "a") as fp:
        #     json.dump(message, fp)
        #     print('dictionary saved successfully to common file')
